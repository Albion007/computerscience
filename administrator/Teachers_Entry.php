...
if($sql_ins==true)
	...
	$msg="Insert Error:"or die(mysql_error());
	}
//------------------uodate data----------
...
<title>Welcome to Faculty Management system</title>
<link rel="stylesheet" type="text/css" href="css/style_entry.css" />
</head>
...
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> Proffesors Update Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll update your proffesors records into database.</p>
			</div>
...
?>
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> Proffesors Entry Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll add new proffesors detail to record into database.</p>
			</div>
...
<div class="container_form">
    <form method="post">
				...
				<div class="teacher_degree_pos">
					<span class="p_font" style="float: left; margin-left: 88px;">Professor's qualification: </span>
					<div class="select_style" style="border-left-width: 1px; margin-left: 0px; width: 102px; margin-right: 60px; margin-top: 0px; margin-bottom: 0px;">
    					<select name="degree">
       						<option>Degree</option>
       						<?php
